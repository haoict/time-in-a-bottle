...
public class ItemTimeInABottle extends AbstractItemTiab {
  ...
  public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
    ...
    tooltip.add(new StringTextComponent(I18n.format("item.tiab.timeinabottle.tooltip", hours, String.format("%02d", minutes), String.format("%02d", seconds))).mergeStyle(TextFormatting.GREEN));
  }
